...
A Ferroptotic Approach to Refractory Cancers]


Welcome to the supplementary repository for my poster presented at Biology & Bioinformatics Olympiad 3.0,2026. 
...
To run the analysis tools:
 "Run the script `ferroptosis_heatmap.R` in RStudio to reproduce the charts."

##  Requirements
*  R version 4.0 or higher , Microsoft Excel
...
Email : humayrakabir.cu.42@gmail.com 
LinkedIn: https://www.linkedin.com/in/humayra-kabir-ahona-584154426
